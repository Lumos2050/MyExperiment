...
#定义训练方法
def train_model(model, train_loader, optimizer, epoch, lamda1=0.01, lamda2=0.01, lamda3 = 0.001):
    ...
    for step, (ms, pan, label, _) in enumerate(loop):
        ...
        optimizer.zero_grad()
        output, mse_msf, mse_pan, reconstruction_loss = model(ms, pan)
