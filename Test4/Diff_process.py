...
class MyData1(Dataset):
    ...
    def __len__(self):
        return len(self.gt_xy)
train_data = MyData(MT, MP, PT, label_train,ground_xy_ltrain, Ms4_patch_size)
test_data = MyData(MT, MP, PT, label_test ,ground_xy_ltest, Ms4_patch_size)########
