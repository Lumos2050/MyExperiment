...
class SqueezeBodyEdge(nn.Module):
    ...
    def __init__(self, inplane):
        ...
        self.conv_5to4 = nn.Sequential(
            nn.Conv2d(inplane + 1, inplane, kernel_size=3, padding=1, bias=False),
            nn.BatchNorm2d(inplane),
            nn.ReLU(inplace=True))
        self.fc = ResNet18()
...
#init的归一化在canny函数里面
        ...
        weighted_image, seg_edge, mse_msf, mse_pan = canny_weight(msf_init, pan_init, seg_edge, low = 50, high = 150)#包含归一化(B, 1, H, W)
